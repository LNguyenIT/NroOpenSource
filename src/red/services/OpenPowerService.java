...
public class OpenPowerService {
    ...
    public static final int COST_SPEED_OPEN_LIMIT_POWER = 5000;
...
//            if (player.nPoint.power >= 17900000000L) {
            ...
            if (!player.isPet) {
                Service.gI().sendThongBao(player, "Bạn đã thăng cấp");
            } else {
                Service.gI().sendThongBao(((Pet) player).master, "Đệ tử đã thăng cấp");
            }
            return true;
//            } else {
//                if (!player.isPet) {
