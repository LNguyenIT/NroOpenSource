        ...
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            if(Util.isTrue(40, 100)){
                ...
                if(Util.isTrue(95, 100)){
                    ...
                    Item ct = ItemService.gI().createNewItem((short) 17, 999);
                    InventoryServiceNew.gI().addItemBag(pl, ct);
                    InventoryServiceNew.gI().sendItemBags(pl);
                }               
        ...
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            ...
            if (Util.isTrue(5, 100)) {
                ...
                if(Util.isTrue(15, 100)){
                    ...
                    ct.itemOptions.add(new ItemOption(77, Util.nextInt(15)));
                    ct.itemOptions.add(new ItemOption(14, Util.nextInt(5)));   
                    ct.itemOptions.add(new ItemOption(5, Util.nextInt(7)));  
                }               
                InventoryServiceNew.gI().addItemBag(pl, ct);
                InventoryServiceNew.gI().sendItemBags(pl);
                ...
                Item ct = ItemService.gI().createNewItem((short) 17, 49);
                InventoryServiceNew.gI().addItemBag(pl, ct);
                InventoryServiceNew.gI().sendItemBags(pl);
                Service.gI().sendThongBao(pl, "|2|Bạn nhận được 4 sao");
            }
            //
            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
            InventoryServiceNew.gI().sendItemBags(pl);
        ...
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 1) {
            switch (item.template.id) {
                case 1322:
                    ...
                    qua20.itemOptions.add(new Item.ItemOption(49, 30));
                    qua20.itemOptions.add(new Item.ItemOption(77, 30));
                    qua20.itemOptions.add(new Item.ItemOption(103, 30));
...
//                    item.itemOptions.add(new Item.ItemOption(117, Util.nextInt(40, 40)));
                ...
                case 1323:
                    ...
                    quatop2_1.itemOptions.add(new Item.ItemOption(49, 35));
...
//            short[] icon = new short[2];
            ...
            if (Util.isTrue(9, 1000)) {
                ...
                Service.gI().sendThongBao(pl, "Bạn vừa mở ra " + tv + " thỏi vàng!");
