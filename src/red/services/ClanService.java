...
import red.models.Template.FlagBag;
import red.team.clan.Clan;
import red.team.clan.ClanMember;
import red.team.clan.ClanMessage;
...
import static red.team.clan.Clan.DEPUTY;
import static red.team.clan.Clan.LEADER;
import static red.team.clan.Clan.MEMBER;
...
public class ClanService {
    ...
    public List<Clan> getClans(String name) {
        ...
        if (Manager.CLANS.size() <= 20) {
            for (Clan clan : Manager.CLANS) {
                if (clan.name.contains(name) && clan.deleted == 0) {
                    listClan.add(clan);
                }
            }
        } else {
    ...
    public void getClan(Player player, Message msg) {
        try {
            ...
            e.printStackTrace();
            Logger.logException(Manager.class, e, "Lỗi getclan");
                    ...
                    if (cmg.receiveDonate < cmg.maxDonate) {
                        ...
                        if (plReceive != null) {
                            ...
                            if (pea != null) {
                                ...
                                Service.gI().sendThongBao(plReceive, plGive.name + " đã bố thí cho bạn " + peaCopy.template.name);
                                cmg.receiveDonate++;
        ...
        try {
            if (player.clan == null) {
                ...
                if (clan != null && clan.getCurrMembers() < clan.maxMember) {
                    ...
                    ItemTimeService.gI().sendTextMiNuong(player);
        ...
        if (clan != null) {
            ...
            if (cm != null) {
                if ((cm.timeAskPea + 1000 * 60 * 5) < System.currentTimeMillis()) {
                    ...
                    Service.gI().sendThongBao(player, "Xin lắm thế?");
                }
            }
        }
    }
    ...
    public void leaveClan(Player player) {
        ...
        if (clan != null) {
            ...
            if (cm != null) {
                ...
                ItemTimeService.gI().removeTextMiNuong(player);
    ...
    public void kickOut(Player player, int memberId) {
        ...
        if (clan != null && cm != null
            ...
            if (plKicked != null) {
                ...
                ItemTimeService.gI().removeTextMiNuong(plKicked);
            } else {
