...
import red.models.Template.HeadAvatar;
import red.models.Template.MapTemplate;
import red.models.Template.MobTemplate;
import red.models.Template.NpcTemplate;
import red.models.Template.SkillTemplate;
...
public class DataGame {
    ...
    public static String LINK_IP_PORT = "Lucy:sv.lucy.com:14445:0";
    ...
    public static void sendVersionGame(MySession session) {
        ...
        try {
            ...
            Logger.logException(Manager.class, e, "Lỗi load sendVersionGame");
        }
    }
    ...
    public static void updateData(MySession session) {
        ...
        try {
            ...
            Logger.logException(Manager.class, e, "Lỗi updatedata");
        }
    }
    ...
    public static void updateMap(MySession session) {
        ...
        try {
            ...
            Logger.logException(Manager.class, e, "Lỗi update map");
        }
    }
    ...
    public static void updateSkill(MySession session) {
        ...
        try {
            ...
            Logger.logException(Manager.class, e, "Lỗi update skill");
        }
    }
    ...
    public static void sendDataImageVersion(MySession session) {
        ...
        try {
            ...
            Logger.logException(Manager.class, e, "Lỗi load sendDataImageVersion");
        }
    }
    ...
    public static void sendDataItemBG(MySession session) {
        ...
        try {
            ...
            Logger.logException(Manager.class, e, "Lỗi sendDataItemBG");
        }
    }
