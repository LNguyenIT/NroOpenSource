...
//        }
    ...
    private List<ItemMap> mobReward(Player player, ItemMap itemTask, Message msg) {// điều chỉnh hàm nhận thức ăn
        ...
        try {
            ...
            if (!player.isPet  && (this.zone.map.mapId > 159 && this.zone.map.mapId < 164)) {
...
if((!player.isPet ) && (this.zone.map.mapId > 104 && this.zone.map.mapId < 111 || this.zone.map.mapId == 159)){
