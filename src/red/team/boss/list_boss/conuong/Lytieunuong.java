...
public class Lytieunuong extends Boss {

    public Lytieunuong() throws Exception {
        super(BossID.LYTIEUNUONG, BossesData.LYTIEUNUONG);
    }
    @Override
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(5, 100)) {
           ...
           Item item = ItemService.gI().createNewItem((short) 464);
            ...
            item.itemOptions.add(new Item.ItemOption(49, Util.nextInt(20, 25)+10));
            item.itemOptions.add(new Item.ItemOption(77, Util.nextInt(20, 25)+10));
            item.itemOptions.add(new Item.ItemOption(103, Util.nextInt(15, 20)+15));
            item.itemOptions.add(new Item.ItemOption(14, Util.nextInt(10, 30)));
            item.itemOptions.add(new Item.ItemOption(5, Util.nextInt(10, 40)));
