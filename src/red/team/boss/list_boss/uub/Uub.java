package red.team.boss.list_boss.uub;
...
public class Uub extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        int[] NRs = new int[] { 15, 16, 16, 16, 16,16, 16, 16, 16 };
        ...
        Service.gI().dropItemMap(this.zone, Util.ratiItem(zone, 861, 500, this.location.x, this.location.y, plKill.id));
        plKill.pointBoss += 1;
   ...
   public long injured(Player plAtt, long damage, boolean piercing, boolean isMobAttack) {
    ...
    public void active() {
        ...
        if (Util.canDoWithTime(st, 360000)) {
