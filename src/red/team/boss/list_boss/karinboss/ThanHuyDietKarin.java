 ...
 * @Stole By Lucy#0800
 */
public class ThanHuyDietKarin extends Boss {

    public ThanHuyDietKarin(int bossID, BossData bossData, Zone zone,Player plTarget) throws Exception {
    ...
    public void reward(Player plKill) {
        ...
        if(plKill.pointKarin < 6){
            plKill.pointKarin = 6;
        }
        plKill.achievement.plusCount(16);
    ...
    public void active() {
        ...
        if (this.playerTarger != null && Client.gI().getPlayer(this.playerTarger.id) == null) {
            playerTarger.haveThanHuyDiet = false;
            this.leaveMap();
        }
