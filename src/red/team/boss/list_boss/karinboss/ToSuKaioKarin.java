 ...
 * @Stole By Lucy#0800
 */
public class ToSuKaioKarin extends Boss {

    public ToSuKaioKarin(int bossID, BossData bossData, Zone zone,Player plTarget) throws Exception {
    ...
    public void active() {
        ...
        if (this.playerTarger != null && Client.gI().getPlayer(this.playerTarger.id) == null) {
            playerTarger.haveToSuKaio = false;
            this.leaveMap();
        }
