...
public class ItemTime {
    ...
    public long lastTimeCand2;
    public boolean isCand3;
    public long lastTimeCand3;
    public boolean isCand4;
    public long lastTimeCand4;
    public short iconCand1;
...
//        }
        ...
        if (isCand2) {
            if (Util.canDoWithTime(lastTimeCand2, TIME_ITEM)) {
                isCand2 = false;
            }
        }
        if (isCand3) {
            if (Util.canDoWithTime(lastTimeCand3, TIME_ITEM)) {
                isCand3 = false;
            }
        }
        if (isCand4) {
