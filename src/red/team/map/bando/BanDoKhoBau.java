package red.team.map.bando;
import java.util.ArrayList;
import java.util.List;

import red.team.boss.bdkb.TrungUyXanhLo;
...
public class BanDoKhoBau implements Runnable{ 
    ...
    public static final long POWER_CAN_GO_TO_DBKB = 20000000;

    public static final List<BanDoKhoBau> BAN_DO_KHO_BAUS;
    public static final int MAX_AVAILABLE = 9;
    public static final int TIME_BAN_DO_KHO_BAU = 3000000;
